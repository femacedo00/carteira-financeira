...
use App\Http\Requests\TransferRefundRequest;
...
class TransactionController extends Controller
{
    ...
    public function transferRefund(TransferRefundRequest $request): JsonResponse
    {
        try {
            // Get the token of deposit
            $refund = $request->validated();
            ...
            // Refound the deposit
            $deposit = $this->transferService->executeRefundTransfer($user, $refund);

            return Response()->json([
                'message' => 'Transfer refund processed successfully',
                'data' => $deposit,
            ], 201);
        } catch (Exception $e) {
            return response()->json([
